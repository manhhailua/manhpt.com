...
- Script: [`benchmark_cache.py`](https://github.com/manhhailua/manhpt.com/blob/master/benchmark_cache.py)
...
> Script đầy đủ: [`benchmark_cache.py`](https://github.com/manhhailua/manhpt.com/blob/master/benchmark_cache.py) | Kết quả raw: [`benchmark_cache_results.json`](https://github.com/manhhailua/manhpt.com/blob/master/benchmark_cache_results.json)
